...
function scheduleMusic() {
  ...
  const leadNotes = [
    523.25, 587.33, 659.25, 783.99, 659.25, 587.33, 523.25, 0, 659.25, 783.99, 880, 1046.5, 880, 783.99, 659.25, 0
  ];
...
function startMusic() {
  ...
  state.musicGain.gain.exponentialRampToValueAtTime(0.8, state.audioContext.currentTime + 0.35);
